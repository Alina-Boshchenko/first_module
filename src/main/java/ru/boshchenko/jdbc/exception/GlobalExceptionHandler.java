...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handlerDataAccess(DataAccessException e) {
        return ResponseEntity.status(500).body(e.getMessage());
    }

    @ExceptionHandler(NotFoundOrUpdateNotSuccessfulException.class)
    public ResponseEntity<String> handlerNotFound(NotFoundOrUpdateNotSuccessfulException e) {
