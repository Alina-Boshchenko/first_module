package ru.boshchenko.object_mapper.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handlerParsJson(JsonProcessingException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("JSON parsing error "+e.getMessage());
    }
